;(function (win, $) {
    ...
    jing.namespace('jing.page.home')

    $.extend(jing.page.home, {
        init: function () {
            this.setBanner()
            this.navAnim()
        },
...
;(function (win, $) {
    ...
    jing.namespace('jing.page.design')

    $.extend(jing.page.design, {
        init: function () {
            this.bind()
            this.sendComment()
            this.saySupport()
...
;(function (win, $) {
    ...
    jing.namespace('jing.page.blog')

    $.extend(jing.page.blog, {
        init: function () {
            this.bind()
        },
        bind: function () {
